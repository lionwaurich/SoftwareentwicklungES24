...
def highlight_state_and_edges(G, pos, state):
    ...
    # Zeichne alle Knoten in einer Basisfarbe
    nx.draw(G, pos, with_labels=True, node_size=3000, node_color="skyblue", font_size=9, font_weight='bold', arrowstyle='-|>', arrowsize=20)
    # Hervorheben des ausgewählten Zustands und der Kanten
